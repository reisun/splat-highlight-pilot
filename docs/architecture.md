...
10. [orchestrator] ---(FFmpeg clip)---> /shared-data/results/{job_id}.mp4
11. [orchestrator] ---(delete)---> /shared-data/uploads/{job_id}_{filename}
...
7. 内蔵 FFmpeg でハイライト区間をクリッピング・結合し `{job_id}.mp4` を出力
